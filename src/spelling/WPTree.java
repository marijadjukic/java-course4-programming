...
public class WPTree implements WordPath {
	...
	public List<String> findPath(String word1, String word2) 
	{
        ...
        visited.add(word1);
        queue.add(root);
        while (!queue.isEmpty() && !queue.element().equals(word2)){
    ...
    public static void main(String[] args) {
	    ...
	    List<String> wordPath = wpt.findPath("time", "theme");
        System.out.println("Word path from \"time\" to \"theme\": ");
        System.out.println(wordPath+"\n");

        wordPath = wpt.findPath("the", "kangaroo");
        System.out.println("Word path from \"the\" to \"kangaroo\": ");
        System.out.println(wordPath+"\n");

        wordPath = wpt.findPath("the", "bll");
        System.out.println("Word path from \"the\" to \"bll\": ");
        System.out.println(wordPath+"\n");
    }
